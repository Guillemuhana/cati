            ...
            <motion.header variants={reveal} className="flex items-start justify-between gap-4 sm:gap-6">
              ...
              <div className="shrink-0">
                {business?.logo_url ? (
                  ...
                  <img src="/numera-icon.png" alt="" className="h-[83px] w-[83px] sm:h-[125px] sm:w-[125px]" />
                )}
              </div>
            </motion.header>
            ...
            {safePdfUrl(budget.pdf_url) && (
              <motion.div variants={reveal} className="mt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 rounded-xl2 border border-line bg-paper/60 px-4 py-3.5 transition hover:border-ink-faint"
                >
